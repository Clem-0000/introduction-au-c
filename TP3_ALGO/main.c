 ...
 * Partie 2
 * ***********************************************************************************************/
    printf("NOMBRE OCCURENCES 36 IN LISTE : %d\n", nb_Occu(36, liste_chaine));
    printf("2E IN LISTE : %d\n", kieme(liste_chaine, 2));
    printf("POS 36 IN LISTE : %d\n", pos(liste_chaine, 36));
    printf("ADDR 36 IN LISTE : %d\n", adr(liste_chaine, 36));
/* ************************************************************************************************
 * Partie 3
 * ***********************************************************************************************/
    iter_inverse(&liste_chaine);
    afficher(liste_chaine);
